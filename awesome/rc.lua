...
-- start picom with awesome
awful.util.spawn_with_shell("picom -b")
-- make sure key map is sent
awful.util.spawn_with_shell("xmodmap /home/showven/.Xmodmap")
-- spawn with shell the 144 hz screen
awful.util.spawn_with_shell("xrandr --output DP-2 --mode '1920x1080' --rate 144")
